        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="surface-card p-6">
            ...
            <div className="space-y-3">
              <label
                className={`flex items-center gap-3 p-3 border-2 rounded-lg cursor-pointer transition-all ${deliveryMethod === "PICKUP" ? "border-[var(--store-primary)] bg-[var(--store-primary-light)]" : "border-border hover:bg-[var(--surface)]"}`}
              >
                <input
                  type="radio"
                  name="delivery"
              ...
              <label
                className={`flex items-center gap-3 p-3 border-2 rounded-lg cursor-pointer transition-all ${deliveryMethod === "SHIPPING" ? "border-[var(--store-primary)] bg-[var(--store-primary-light)]" : "border-border hover:bg-[var(--surface)]"}`}
              >
                <input
                  type="radio"
                  name="delivery"
          ...
          <div className="surface-card p-6">
            ...
            <div className="space-y-3">
              <label
                className={`flex items-center gap-3 p-3 border-2 rounded-lg cursor-pointer transition-all ${paymentMethod === "TRANSFER" ? "border-[var(--store-primary)] bg-[var(--store-primary-light)]" : "border-border hover:bg-[var(--surface)]"}`}
              >
                <input
                  type="radio"
                  name="payment"
                ...
                <div className="flex items-center gap-3">
                  <svg
                    className="w-8 h-6 text-muted shrink-0"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted">
                      Recibiras los datos bancarios por email
                    </p>
                  </div>
                </div>
              </label>
              <label
                className={`flex items-center gap-3 p-3 border-2 rounded-lg cursor-pointer transition-all ${paymentMethod === "WEBPAY" ? "border-[var(--store-primary)] bg-[var(--store-primary-light)]" : "border-border hover:bg-[var(--surface)]"}`}
              >
                <input
                  type="radio"
                  name="payment"
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted">
                      Pago inmediato con tarjeta de credito o debito
                    </p>
                  </div>
                </div>
              </label>
          ...
          <div className="surface-card p-6">
            <label className="flex items-start gap-3 cursor-pointer">
              ...
              <span className="text-sm text-foreground">
                ...
                . Todos los precios incluyen IVA. Derecho a retracto de 10 dias
                habiles segun ley del consumidor.
              </span>
            </label>
            {errors.terms && (
              <p className="text-danger text-xs mt-2 ml-7">{errors.terms}</p>
            )}
          </div>
        </div>
