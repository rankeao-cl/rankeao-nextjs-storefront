    ...
    >
      ...
      >
        ...
        <div 
          ...
          style={{
            background: "linear-gradient(to top, rgba(0,0,0,0.75) 0%, rgba(0,0,0,0.25) 40%, rgba(0,0,0,0.05) 100%)"
          }}
        />
        ...
        {tile.title && (
          <div className="absolute inset-0 flex flex-col justify-end p-5 md:p-7">
            <motion.span 
              className="text-white font-semibold text-lg md:text-xl drop-shadow-sm"
            ...
            <motion.span
              className="inline-flex items-center gap-1.5 text-white/80 text-sm mt-1.5 link-arrow"
              initial={{ y: 10, opacity: 0 }}
              whileInView={{ y: 0, opacity: 1 }}
              viewport={{ once: true }}
