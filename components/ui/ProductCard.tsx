      ...
      <div className="px-1">
        {outOfStock ? (
          ...
          <button
            ...
            disabled={isAdding}
            className="w-full flex items-center justify-center gap-1.5 py-2 bg-blue-600 hover:bg-blue-700 text-white text-xs font-semibold rounded transition-colors disabled:opacity-70"
          >
            {isAdding ? (
