...
export default function Header() {
  ...
  const textColorClass = isHome && !hasScrolled ? "text-white" : "text-foreground";
  const textMutedClass = isHome && !hasScrolled ? "text-white/70" : "text-muted";
  ...
  return (
    <>
      <motion.header
        ...
        style={{
          backgroundColor: isHome ? headerBg : "var(--surface-solid)",
          borderBottomWidth: "1px",
          borderBottomStyle: "solid",
          borderBottomColor: isHome ? headerBorder : "var(--border)",
          backdropFilter: hasScrolled || !isHome ? "blur(20px) saturate(180%)" : "none",
          WebkitBackdropFilter: hasScrolled || !isHome ? "blur(20px) saturate(180%)" : "none",
        }}
      >
        {/* Promo bar */}
        {!promoDismissed && (
            ...
            <Link href="/" className="shrink-0">
              ...
              >
                <Image
                  ...
                  priority
                  style={{
                    filter: isHome && !hasScrolled ? "brightness(0) invert(1)" : "none",
                  }}
                />
              </motion.div>
            </Link>
      ...
      <div className={`h-14 md:h-16 ${!promoDismissed ? "mt-8" : ""}`} />
